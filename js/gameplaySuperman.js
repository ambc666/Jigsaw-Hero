...
function pad(timeValue) {
    return timeValue > 9 ? timeValue : "0" + timeValue; //placeholder for 00 in span
}
setInterval(function () {
    ...
    if (dropAll == 25) {
        ...
        window.location = 'gameplayhard_leaderboard.php';
    }
}, 1000);
...
$(function () { //Function opens
    ...
    $("#puzzle17").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle17').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle17').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
    ...
    $("#puzzle18").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle18').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle18').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
    ...
    $("#puzzle19").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle19').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle19').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
    ...
    $("#puzzle20").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle20').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle20').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
    ...
    $("#puzzle21").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle21').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle21').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
    ...
    $("#puzzle22").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle22').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle22').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
    ...
    $("#puzzle23").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle23').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle23').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
    ...
    $("#puzzle24").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle24').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle24').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
    ...
    $("#puzzle25").droppable({
        ...
        activeClass: 'highlight',
        drop: function (event, ui) {
            $('#puzzle25').addClass('pieceDropped');
            $('#dropAudio')[0].play();
            $('#puzzle25').fadeTo(1000, 0);
            ui.helper.hide('explode', {
                pieces: 20
            }, 1000);
        }
